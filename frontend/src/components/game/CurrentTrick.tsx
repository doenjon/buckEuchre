...
export function CurrentTrick({
  ...
  if (!trick || trick.cards.length === 0) {
    return (
      <div
        className="flex w-full h-full items-center justify-center rounded-[3rem] border border-white/10 bg-gradient-to-br from-emerald-950/90 via-emerald-900/80 to-emerald-800/60 shadow-lg md:shadow-2xl backdrop-blur"
        role="region"
  ...
  return (
    <div
      className="relative flex w-full h-full items-center justify-center overflow-visible rounded-[3rem] border border-white/10 bg-gradient-to-br from-emerald-950/90 via-emerald-900/80 to-emerald-800/60 shadow-lg md:shadow-[0_30px_80px_-40px_rgba(16,185,129,0.9)] backdrop-blur"
      role="region"
